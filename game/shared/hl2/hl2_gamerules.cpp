...
//ConVar	sk_plr_dmg_dalekgun		("sk_plr_dmg_dalekgun", "0", FCVAR_REPLICATED);
//ConVar	sk_npc_dmg_dalekgun		("sk_npc_dmg_dalekgun", "0", FCVAR_REPLICATED);
ConVar	sk_max_dalekgun_round	("sk_max_dalekgun_round", "0", FCVAR_REPLICATED);
...
ConVar  alyx_darkness_force( "alyx_darkness_force", "0", FCVAR_CHEAT | FCVAR_REPLICATED );
	...
	void CHalfLife2::InitDefaultAIRelationships(void)
	{
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ANTLION, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BARNACLE, CLASS_DALEK, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_BULLSEYE, CLASS_DALEK, D_NU, 0);
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_PASSIVE, CLASS_DALEK, D_FR, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CITIZEN_REBEL, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_GUNSHIP, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_COMBINE_HUNTER, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_CONSCRIPT, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_FLARE, CLASS_DALEK, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HEADCRAB, CLASS_DALEK, D_FR, 0);
		...
		*/
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MANHACK, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_METROPOLICE, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MILITARY, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_MISSILE, CLASS_DALEK, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_NONE, CLASS_DALEK, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PLAYER_ALLY_VITAL, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_SCANNER, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_STALKER, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_VORTIGAUNT, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_ZOMBIE, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_PROTOSNIPER, CLASS_DALEK, D_NU, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_EARTH_FAUNA, CLASS_DALEK, D_HT, 0);
		...
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_HACKED_ROLLERMINE, CLASS_DALEK, D_HT, 0);

		// ------------------------------------------------------------
		//	> CLASS_DALEK
		// ------------------------------------------------------------
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_NONE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_PLAYER, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_ANTLION, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_BARNACLE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_BULLSEYE, D_NU, 0);
		//CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK,		CLASS_BULLSQUID,		D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_CITIZEN_PASSIVE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_CITIZEN_REBEL, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_COMBINE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_COMBINE_GUNSHIP, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_COMBINE_HUNTER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_CONSCRIPT, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_FLARE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_HEADCRAB, D_HT, 0);
		//CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK,		CLASS_HOUNDEYE,			D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_MANHACK, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_DALEK, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_MILITARY, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_MISSILE, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_SCANNER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_STALKER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_VORTIGAUNT, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_ZOMBIE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_PROTOSNIPER, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_EARTH_FAUNA, D_NU, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_PLAYER_ALLY, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_PLAYER_ALLY_VITAL, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_HACKED_ROLLERMINE, D_HT, 0);
		CBaseCombatCharacter::SetDefaultRelationship(CLASS_DALEK, CLASS_METROPOLICE, D_HT, 0);
	}
	//------------------------------------------------------------------------------
	...
	const char* CHalfLife2::AIClassText(int classType)
	{
		switch (classType)
		{
			...
			case CLASS_DALEK:			return "CLASS_DALEK";
...
//		def.AddAmmoType("Extinguisher",		DMG_BURN,					TRACER_NONE,			0,	0, 100, 0, 0 );
		...
		def.AddAmmoType("DalekAmmo",		DMG_SHOCK,					TRACER_NONE,			"sk_plr_dmg_dalekgun", "sk_npc_dmg_dalekgun", "sk_max_dalekgun_round", BULLET_IMPULSE(650, 8000), 0);
