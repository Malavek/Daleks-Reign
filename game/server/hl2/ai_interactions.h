...
//Dalek
extern int	g_interactionDalekStomp;
extern int	g_interactionDalekStompFail;
extern int	g_interactionDalekStompHit;
extern int	g_interactionDalekKick;
extern int	g_interactionDalekClaw;
extern int	g_interactionDalekBash; // melee bash attack
