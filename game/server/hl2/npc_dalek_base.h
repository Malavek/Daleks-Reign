...
#ifndef NPC_DALEK_BASE_H
#define NPC_DALEK_BASE_H
...
//-----------------------------------------------------------------------------
//
// CLASS: CNPC_Dalek_Base
//
//-----------------------------------------------------------------------------

class CNPC_Dalek_Base : public CAI_PlayerAlly
{
	DECLARE_CLASS( CNPC_Dalek_Base, CAI_PlayerAlly );
...
public:
	...
	virtual bool			ValidEyeTargetDalek(const Vector &lookTargetPos);
	virtual bool			ValidHeadTargetDalek(const Vector &lookTargetPos);
